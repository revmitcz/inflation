...
function sahrWrapper(y1, y2, dollars) {
  if (y1 < cpi0) {
    ...
    y1 = 2004;
    return cpiWrapper(y1, y2, dollars).toFixed(0);
  }
...
console.log(calculate(2009, 2012, 5));
